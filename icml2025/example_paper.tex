...
\begin{lemma}
    ...
    At the $k$-th iteration of Algorithm~\ref{alg.accelerated utr}, the number of linear equations solved during the bisection search procedure is at most $O(\log \frac{\|\nabla f(y_k)\|}{\epsilon})$.
\end{lemma}
