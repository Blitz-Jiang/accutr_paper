...
Both \atrms{} and \arca{} converge sublinearly in the local regime, in which \atrms{} is slightly better because of its superior $\tilde O(\epsilon_f^{-2/7})$ non-asymptotic performance. These results are in accordance with what is predicted in the convergence analysis. \cz{Can we design a locally superlinear method based on the A-NPE framework? This question is left as a future work.}
