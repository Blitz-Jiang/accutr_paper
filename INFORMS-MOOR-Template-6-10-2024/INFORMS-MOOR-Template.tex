...
\cz{
    The second is the accelerated Newton proximal extragradient (A-NPE) method~\cite{monteiro2013accelerated}, which attains an oracle complexity of $\tilde{O}(\epsilon^{-2/7})$~\cite{carmon2022optimal} using second-order oracles satisfying certain error-bound conditions.
}
...
\cz{More recently, the logarithmic factor in the oracle complexity of A-NPE was eliminated, yielding the optimal rate of} $O(\epsilon^{-2/7})$~\cite{carmon2022optimal,kovalev2022first}. In fact, these acceleration techniques are broadly applicable and are by no means limited to the domain of SOMs~\cite{xu2017accelerated,xu2018accelerated,lan2012optimal,ghadimi2016accelerated}.
