...
\newcommand{\cz}[1]{{\color{darkpastelgreen}#1}}
...
% Override equation environment with reduced spacing
\let\oldequation\equation
\let\endoldequation\endequation
\renewenvironment{equation}
{\setlength{\abovedisplayskip}{6pt}\setlength{\belowdisplayskip}{3pt}\oldequation}
{\endoldequation}

% Override $$ display math with reduced spacing
\everydisplay{\setlength{\abovedisplayskip}{6pt}\setlength{\belowdisplayskip}{3pt}}

% Reduce spacing in equation environments
